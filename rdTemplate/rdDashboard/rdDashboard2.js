...
function rdSaveEditedAgViz(sReport, sVizType, sPanelID, sInstanceID, sBookmarkID) {
    ...
    rdPanelParams += '&rdBookmarkID=' + sBookmarkID
     ...
     var sRefreshScript = "rdAjaxRequestWithFormVars('rdAjaxCommand=rdAjaxNotify&rdNotifyCommand=SaveEditedAgViz" + rdPanelParams + "');"
     window.parent.eval(sRefreshScript)
